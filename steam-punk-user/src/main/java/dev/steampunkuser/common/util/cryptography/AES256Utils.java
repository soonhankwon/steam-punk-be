package dev.steampunkuser.common.util.cryptography;
...
public class AES256Utils {
     ...
     * @return
     */
    private static Cipher getCipher(int decryptMode) throws InvalidAlgorithmParameterException, InvalidKeyException {
        ...
        try {
            ...
            throw new ApiException(ErrorCode.CRYPTOGRAPHY_FAILED);
        }
    }

    private static SecretKeySpec getAESKeySpec() {
        byte[] key = DECODER_BASE64.decode(secretKeyAES);
        return new SecretKeySpec(key, ALGORITHM_AES_KEY);
    }
